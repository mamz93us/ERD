...
class TranslationSeeder extends Seeder
{
    public function run(): void
    {
        $rows = [
            ...
            // Phase 8 navigation
            ['group' => 'navigation', 'key' => 'accounting', 'text_ar' => 'المحاسبة', 'text_en' => 'Accounting'],
            ['group' => 'navigation', 'key' => 'invoices', 'text_ar' => 'الفواتير', 'text_en' => 'Invoices'],
            ['group' => 'navigation', 'key' => 'payments', 'text_ar' => 'المدفوعات', 'text_en' => 'Payments'],
            ['group' => 'navigation', 'key' => 'credit_notes', 'text_ar' => 'إشعارات الائتمان', 'text_en' => 'Credit Notes'],
            ['group' => 'navigation', 'key' => 'vendor_bills', 'text_ar' => 'فواتير الموردين', 'text_en' => 'Vendor Bills'],
            ['group' => 'navigation', 'key' => 'expenses', 'text_ar' => 'المصروفات', 'text_en' => 'Expenses'],

            // Phase 8 enums — InvoiceStatus
            ['group' => 'enums', 'key' => 'invoice_status.draft', 'text_ar' => 'مسودة', 'text_en' => 'Draft'],
            ['group' => 'enums', 'key' => 'invoice_status.sent', 'text_ar' => 'مُرسلة', 'text_en' => 'Sent'],
            ['group' => 'enums', 'key' => 'invoice_status.partially_paid', 'text_ar' => 'مدفوعة جزئياً', 'text_en' => 'Partially paid'],
            ['group' => 'enums', 'key' => 'invoice_status.paid', 'text_ar' => 'مدفوعة', 'text_en' => 'Paid'],
            ['group' => 'enums', 'key' => 'invoice_status.overdue', 'text_ar' => 'متأخرة', 'text_en' => 'Overdue'],
            ['group' => 'enums', 'key' => 'invoice_status.cancelled', 'text_ar' => 'ملغاة', 'text_en' => 'Cancelled'],

            // CreditNoteStatus
            ['group' => 'enums', 'key' => 'credit_note_status.draft', 'text_ar' => 'مسودة', 'text_en' => 'Draft'],
            ['group' => 'enums', 'key' => 'credit_note_status.pending_approval', 'text_ar' => 'بانتظار الموافقة', 'text_en' => 'Pending approval'],
            ['group' => 'enums', 'key' => 'credit_note_status.approved', 'text_ar' => 'مُعتمدة', 'text_en' => 'Approved'],
            ['group' => 'enums', 'key' => 'credit_note_status.applied', 'text_ar' => 'مُطبقة', 'text_en' => 'Applied'],
            ['group' => 'enums', 'key' => 'credit_note_status.rejected', 'text_ar' => 'مرفوضة', 'text_en' => 'Rejected'],

            // CreditNoteReason
            ['group' => 'enums', 'key' => 'credit_note_reason.cancellation', 'text_ar' => 'إلغاء', 'text_en' => 'Cancellation'],
            ['group' => 'enums', 'key' => 'credit_note_reason.service_complaint', 'text_ar' => 'شكوى على الخدمة', 'text_en' => 'Service complaint'],
            ['group' => 'enums', 'key' => 'credit_note_reason.goodwill', 'text_ar' => 'حسن نية', 'text_en' => 'Goodwill'],
            ['group' => 'enums', 'key' => 'credit_note_reason.deposit_return', 'text_ar' => 'استرداد عربون', 'text_en' => 'Deposit return'],
            ['group' => 'enums', 'key' => 'credit_note_reason.billing_error', 'text_ar' => 'خطأ في الفاتورة', 'text_en' => 'Billing error'],
            ['group' => 'enums', 'key' => 'credit_note_reason.other', 'text_ar' => 'أخرى', 'text_en' => 'Other'],

            // PaymentMethod
            ['group' => 'enums', 'key' => 'payment_method.cash', 'text_ar' => 'نقدي', 'text_en' => 'Cash'],
            ['group' => 'enums', 'key' => 'payment_method.bank_transfer', 'text_ar' => 'تحويل بنكي', 'text_en' => 'Bank transfer'],
            ['group' => 'enums', 'key' => 'payment_method.visa', 'text_ar' => 'فيزا', 'text_en' => 'Visa'],
            ['group' => 'enums', 'key' => 'payment_method.mastercard', 'text_ar' => 'ماستر كارد', 'text_en' => 'Mastercard'],
            ['group' => 'enums', 'key' => 'payment_method.fawry', 'text_ar' => 'فوري', 'text_en' => 'Fawry'],
            ['group' => 'enums', 'key' => 'payment_method.instapay', 'text_ar' => 'إنستاباي', 'text_en' => 'InstaPay'],
            ['group' => 'enums', 'key' => 'payment_method.cheque', 'text_ar' => 'شيك', 'text_en' => 'Cheque'],

            // VendorBillStatus
            ['group' => 'enums', 'key' => 'vendor_bill_status.draft', 'text_ar' => 'مسودة', 'text_en' => 'Draft'],
            ['group' => 'enums', 'key' => 'vendor_bill_status.received', 'text_ar' => 'مُستلمة', 'text_en' => 'Received'],
            ['group' => 'enums', 'key' => 'vendor_bill_status.partially_paid', 'text_ar' => 'مدفوعة جزئياً', 'text_en' => 'Partially paid'],
            ['group' => 'enums', 'key' => 'vendor_bill_status.paid', 'text_ar' => 'مدفوعة', 'text_en' => 'Paid'],
            ['group' => 'enums', 'key' => 'vendor_bill_status.disputed', 'text_ar' => 'متنازع عليها', 'text_en' => 'Disputed'],

            // VendorType
            ['group' => 'enums', 'key' => 'vendor_type.partner_agency', 'text_ar' => 'وكالة شريكة', 'text_en' => 'Partner agency'],
            ['group' => 'enums', 'key' => 'vendor_type.garage', 'text_ar' => 'ورشة', 'text_en' => 'Garage'],
            ['group' => 'enums', 'key' => 'vendor_type.fuel', 'text_ar' => 'وقود', 'text_en' => 'Fuel'],
            ['group' => 'enums', 'key' => 'vendor_type.insurance', 'text_ar' => 'تأمين', 'text_en' => 'Insurance'],
            ['group' => 'enums', 'key' => 'vendor_type.other', 'text_ar' => 'أخرى', 'text_en' => 'Other'],

            // ExpenseCategory
            ['group' => 'enums', 'key' => 'expense_category.fuel', 'text_ar' => 'وقود', 'text_en' => 'Fuel'],
            ['group' => 'enums', 'key' => 'expense_category.maintenance', 'text_ar' => 'صيانة', 'text_en' => 'Maintenance'],
            ['group' => 'enums', 'key' => 'expense_category.salaries', 'text_ar' => 'رواتب', 'text_en' => 'Salaries'],
            ['group' => 'enums', 'key' => 'expense_category.insurance', 'text_ar' => 'تأمين', 'text_en' => 'Insurance'],
            ['group' => 'enums', 'key' => 'expense_category.fines', 'text_ar' => 'مخالفات', 'text_en' => 'Fines'],
            ['group' => 'enums', 'key' => 'expense_category.office', 'text_ar' => 'مصاريف مكتبية', 'text_en' => 'Office'],
            ['group' => 'enums', 'key' => 'expense_category.utilities', 'text_ar' => 'مرافق', 'text_en' => 'Utilities'],
            ['group' => 'enums', 'key' => 'expense_category.marketing', 'text_ar' => 'تسويق', 'text_en' => 'Marketing'],
            ['group' => 'enums', 'key' => 'expense_category.depreciation', 'text_ar' => 'إهلاك', 'text_en' => 'Depreciation'],
            ['group' => 'enums', 'key' => 'expense_category.other', 'text_ar' => 'أخرى', 'text_en' => 'Other'],

            // ExpensePaidBy
            ['group' => 'enums', 'key' => 'expense_paid_by.cash', 'text_ar' => 'نقدي', 'text_en' => 'Cash'],
            ['group' => 'enums', 'key' => 'expense_paid_by.bank', 'text_ar' => 'بنك', 'text_en' => 'Bank'],
            ['group' => 'enums', 'key' => 'expense_paid_by.petty_cash', 'text_ar' => 'العهدة', 'text_en' => 'Petty cash'],

            // Invoices field labels
            ['group' => 'invoices', 'key' => 'invoice_number', 'text_ar' => 'رقم الفاتورة', 'text_en' => 'Invoice #'],
            ['group' => 'invoices', 'key' => 'auto_generated_on_save', 'text_ar' => 'يُولَّد تلقائياً عند الحفظ', 'text_en' => 'Auto-generated on save'],
            ['group' => 'invoices', 'key' => 'customer', 'text_ar' => 'العميل', 'text_en' => 'Customer'],
            ['group' => 'invoices', 'key' => 'corporate_account', 'text_ar' => 'حساب الشركة', 'text_en' => 'Corporate account'],
            ['group' => 'invoices', 'key' => 'trip', 'text_ar' => 'الرحلة', 'text_en' => 'Trip'],
            ['group' => 'invoices', 'key' => 'issue_date', 'text_ar' => 'تاريخ الإصدار', 'text_en' => 'Issue date'],
            ['group' => 'invoices', 'key' => 'due_date', 'text_ar' => 'تاريخ الاستحقاق', 'text_en' => 'Due date'],
            ['group' => 'invoices', 'key' => 'subtotal', 'text_ar' => 'المجموع الفرعي', 'text_en' => 'Subtotal'],
            ['group' => 'invoices', 'key' => 'vat_amount', 'text_ar' => 'ضريبة القيمة المضافة', 'text_en' => 'VAT'],
            ['group' => 'invoices', 'key' => 'discount_amount', 'text_ar' => 'الخصم', 'text_en' => 'Discount'],
            ['group' => 'invoices', 'key' => 'total', 'text_ar' => 'الإجمالي', 'text_en' => 'Total'],
            ['group' => 'invoices', 'key' => 'paid_amount', 'text_ar' => 'المدفوع', 'text_en' => 'Paid'],
            ['group' => 'invoices', 'key' => 'balance_due', 'text_ar' => 'الرصيد المستحق', 'text_en' => 'Balance due'],
            ['group' => 'invoices', 'key' => 'currency', 'text_ar' => 'العملة', 'text_en' => 'Currency'],
            ['group' => 'invoices', 'key' => 'status', 'text_ar' => 'الحالة', 'text_en' => 'Status'],
            ['group' => 'invoices', 'key' => 'notes', 'text_ar' => 'ملاحظات', 'text_en' => 'Notes'],
            ['group' => 'invoices', 'key' => 'terms', 'text_ar' => 'الشروط', 'text_en' => 'Terms'],
            ['group' => 'invoices', 'key' => 'mark_sent', 'text_ar' => 'وضع علامة كمُرسلة', 'text_en' => 'Mark as sent'],
            ['group' => 'invoices', 'key' => 'marked_sent', 'text_ar' => 'تم وضع الفاتورة كمُرسلة', 'text_en' => 'Invoice marked as sent'],
            ['group' => 'invoices', 'key' => 'generate_from_trip', 'text_ar' => 'توليد من رحلة', 'text_en' => 'Generate from trip'],
            ['group' => 'invoices', 'key' => 'generate_consolidated', 'text_ar' => 'فاتورة مُجمَّعة لشركة', 'text_en' => 'Generate consolidated'],
            ['group' => 'invoices', 'key' => 'month_start', 'text_ar' => 'بداية الشهر', 'text_en' => 'Month start'],
            ['group' => 'invoices', 'key' => 'month_end', 'text_ar' => 'نهاية الشهر', 'text_en' => 'Month end'],
            ['group' => 'invoices', 'key' => 'generated', 'text_ar' => 'تم توليد الفاتورة :number', 'text_en' => 'Invoice :number generated'],

            // Invoice lines
            ['group' => 'invoice_lines', 'key' => 'description', 'text_ar' => 'الوصف', 'text_en' => 'Description'],
            ['group' => 'invoice_lines', 'key' => 'quantity', 'text_ar' => 'الكمية', 'text_en' => 'Qty'],
            ['group' => 'invoice_lines', 'key' => 'unit_price', 'text_ar' => 'سعر الوحدة', 'text_en' => 'Unit price'],
            ['group' => 'invoice_lines', 'key' => 'discount_amount', 'text_ar' => 'الخصم', 'text_en' => 'Discount'],
            ['group' => 'invoice_lines', 'key' => 'vat_rate', 'text_ar' => 'نسبة الضريبة', 'text_en' => 'VAT %'],
            ['group' => 'invoice_lines', 'key' => 'vat_amount', 'text_ar' => 'قيمة الضريبة', 'text_en' => 'VAT'],
            ['group' => 'invoice_lines', 'key' => 'line_total', 'text_ar' => 'إجمالي البند', 'text_en' => 'Line total'],
            ['group' => 'invoice_lines', 'key' => 'sort_order', 'text_ar' => 'الترتيب', 'text_en' => 'Sort order'],

            // Payments
            ['group' => 'payments', 'key' => 'payment_number', 'text_ar' => 'رقم المدفوعة', 'text_en' => 'Payment #'],
            ['group' => 'payments', 'key' => 'auto_generated_on_save', 'text_ar' => 'يُولَّد تلقائياً', 'text_en' => 'Auto-generated on save'],
            ['group' => 'payments', 'key' => 'customer', 'text_ar' => 'العميل', 'text_en' => 'Customer'],
            ['group' => 'payments', 'key' => 'corporate_account', 'text_ar' => 'حساب الشركة', 'text_en' => 'Corporate account'],
            ['group' => 'payments', 'key' => 'method', 'text_ar' => 'طريقة الدفع', 'text_en' => 'Method'],
            ['group' => 'payments', 'key' => 'amount', 'text_ar' => 'المبلغ', 'text_en' => 'Amount'],
            ['group' => 'payments', 'key' => 'payment_date', 'text_ar' => 'تاريخ الدفع', 'text_en' => 'Payment date'],
            ['group' => 'payments', 'key' => 'reference_number', 'text_ar' => 'الرقم المرجعي', 'text_en' => 'Reference #'],
            ['group' => 'payments', 'key' => 'branch', 'text_ar' => 'الفرع', 'text_en' => 'Branch'],
            ['group' => 'payments', 'key' => 'received_by', 'text_ar' => 'استلمها', 'text_en' => 'Received by'],
            ['group' => 'payments', 'key' => 'is_reconciled', 'text_ar' => 'مُسوَّاة', 'text_en' => 'Reconciled'],
            ['group' => 'payments', 'key' => 'notes', 'text_ar' => 'ملاحظات', 'text_en' => 'Notes'],
            ['group' => 'payments', 'key' => 'allocate', 'text_ar' => 'توزيع على الفواتير', 'text_en' => 'Allocate to invoices'],
            ['group' => 'payments', 'key' => 'allocated', 'text_ar' => 'تم التوزيع بنجاح', 'text_en' => 'Allocations created'],
            ['group' => 'payments', 'key' => 'allocations', 'text_ar' => 'التوزيعات', 'text_en' => 'Allocations'],
            ['group' => 'payments', 'key' => 'invoice', 'text_ar' => 'الفاتورة', 'text_en' => 'Invoice'],
            ['group' => 'payments', 'key' => 'allocation_amount', 'text_ar' => 'المبلغ المُوزَّع', 'text_en' => 'Allocated amount'],

            // Credit notes
            ['group' => 'credit_notes', 'key' => 'note_number', 'text_ar' => 'رقم إشعار الائتمان', 'text_en' => 'Note #'],
            ['group' => 'credit_notes', 'key' => 'auto_generated_on_save', 'text_ar' => 'يُولَّد تلقائياً', 'text_en' => 'Auto-generated on save'],
            ['group' => 'credit_notes', 'key' => 'invoice', 'text_ar' => 'الفاتورة', 'text_en' => 'Invoice'],
            ['group' => 'credit_notes', 'key' => 'reason', 'text_ar' => 'السبب', 'text_en' => 'Reason'],
            ['group' => 'credit_notes', 'key' => 'reason_details', 'text_ar' => 'تفاصيل السبب', 'text_en' => 'Reason details'],
            ['group' => 'credit_notes', 'key' => 'amount', 'text_ar' => 'القيمة', 'text_en' => 'Amount'],
            ['group' => 'credit_notes', 'key' => 'amount_help', 'text_ar' => 'إشعارات الائتمان فوق 5000 جنيه تتطلب موافقة مدير الفرع.', 'text_en' => 'Notes above 5000 EGP need branch manager approval.'],
            ['group' => 'credit_notes', 'key' => 'status', 'text_ar' => 'الحالة', 'text_en' => 'Status'],
            ['group' => 'credit_notes', 'key' => 'issue_date', 'text_ar' => 'تاريخ الإصدار', 'text_en' => 'Issue date'],
            ['group' => 'credit_notes', 'key' => 'created_by', 'text_ar' => 'أنشأه', 'text_en' => 'Created by'],
            ['group' => 'credit_notes', 'key' => 'approved_by', 'text_ar' => 'اعتمده', 'text_en' => 'Approved by'],
            ['group' => 'credit_notes', 'key' => 'approve', 'text_ar' => 'اعتماد', 'text_en' => 'Approve'],
            ['group' => 'credit_notes', 'key' => 'approved', 'text_ar' => 'تم اعتماد الإشعار', 'text_en' => 'Credit note approved'],
            ['group' => 'credit_notes', 'key' => 'reject', 'text_ar' => 'رفض', 'text_en' => 'Reject'],
            ['group' => 'credit_notes', 'key' => 'rejected', 'text_ar' => 'تم رفض الإشعار', 'text_en' => 'Credit note rejected'],
            ['group' => 'credit_notes', 'key' => 'apply', 'text_ar' => 'تطبيق على الفاتورة', 'text_en' => 'Apply to invoice'],
            ['group' => 'credit_notes', 'key' => 'apply_confirm', 'text_ar' => 'سيتم خصم القيمة من الفاتورة. لا يمكن التراجع.', 'text_en' => 'The amount will be deducted from the invoice. This cannot be undone.'],
            ['group' => 'credit_notes', 'key' => 'applied', 'text_ar' => 'تم تطبيق الإشعار', 'text_en' => 'Credit note applied'],

            // Vendor bills
            ['group' => 'vendor_bills', 'key' => 'bill_number', 'text_ar' => 'رقم الفاتورة', 'text_en' => 'Bill #'],
            ['group' => 'vendor_bills', 'key' => 'bill_number_help', 'text_ar' => 'رقم الفاتورة كما يظهر على ورقة المورد.', 'text_en' => "Bill number as it appears on the vendor's document."],
            ['group' => 'vendor_bills', 'key' => 'vendor_type', 'text_ar' => 'نوع المورد', 'text_en' => 'Vendor type'],
            ['group' => 'vendor_bills', 'key' => 'partner_agency', 'text_ar' => 'الوكالة الشريكة', 'text_en' => 'Partner agency'],
            ['group' => 'vendor_bills', 'key' => 'garage', 'text_ar' => 'الورشة', 'text_en' => 'Garage'],
            ['group' => 'vendor_bills', 'key' => 'related_car', 'text_ar' => 'السيارة المرتبطة', 'text_en' => 'Related car'],
            ['group' => 'vendor_bills', 'key' => 'related_sub_rental_contract', 'text_ar' => 'عقد الإيجار الفرعي المرتبط', 'text_en' => 'Related sub-rental contract'],
            ['group' => 'vendor_bills', 'key' => 'bill_date', 'text_ar' => 'تاريخ الفاتورة', 'text_en' => 'Bill date'],
            ['group' => 'vendor_bills', 'key' => 'due_date', 'text_ar' => 'تاريخ الاستحقاق', 'text_en' => 'Due date'],
            ['group' => 'vendor_bills', 'key' => 'subtotal', 'text_ar' => 'المجموع الفرعي', 'text_en' => 'Subtotal'],
            ['group' => 'vendor_bills', 'key' => 'vat_amount', 'text_ar' => 'الضريبة', 'text_en' => 'VAT'],
            ['group' => 'vendor_bills', 'key' => 'total', 'text_ar' => 'الإجمالي', 'text_en' => 'Total'],
            ['group' => 'vendor_bills', 'key' => 'paid_amount', 'text_ar' => 'المدفوع', 'text_en' => 'Paid'],
            ['group' => 'vendor_bills', 'key' => 'balance_due', 'text_ar' => 'الرصيد المستحق', 'text_en' => 'Balance due'],
            ['group' => 'vendor_bills', 'key' => 'status', 'text_ar' => 'الحالة', 'text_en' => 'Status'],
            ['group' => 'vendor_bills', 'key' => 'description', 'text_ar' => 'الوصف', 'text_en' => 'Description'],
            ['group' => 'vendor_bills', 'key' => 'attachment', 'text_ar' => 'المرفق', 'text_en' => 'Attachment'],

            // Expenses
            ['group' => 'expenses', 'key' => 'branch', 'text_ar' => 'الفرع', 'text_en' => 'Branch'],
            ['group' => 'expenses', 'key' => 'category', 'text_ar' => 'الفئة', 'text_en' => 'Category'],
            ['group' => 'expenses', 'key' => 'car', 'text_ar' => 'السيارة', 'text_en' => 'Car'],
            ['group' => 'expenses', 'key' => 'driver', 'text_ar' => 'السائق', 'text_en' => 'Driver'],
            ['group' => 'expenses', 'key' => 'amount', 'text_ar' => 'المبلغ', 'text_en' => 'Amount'],
            ['group' => 'expenses', 'key' => 'expense_date', 'text_ar' => 'تاريخ المصروف', 'text_en' => 'Expense date'],
            ['group' => 'expenses', 'key' => 'paid_by', 'text_ar' => 'مصدر الدفع', 'text_en' => 'Paid by'],
            ...
            ['group' => 'driver', 'key' => 'brand', 'text_ar' => 'بوابة السائقين', 'text_en' => 'Driver Portal'],
            ['group' => 'driver', 'key' => 'login_title', 'text_ar' => 'تسجيل دخول السائق', 'text_en' => 'Driver login'],
            ['group' => 'driver', 'key' => 'login_subtitle', 'text_ar' => 'أدخل رقم هاتفك وكلمة المرور', 'text_en' => 'Enter your phone and password'],
            ['group' => 'driver', 'key' => 'phone_or_id', 'text_ar' => 'رقم الهاتف أو الرقم القومي', 'text_en' => 'Phone or national ID'],
            ['group' => 'driver', 'key' => 'password', 'text_ar' => 'كلمة المرور', 'text_en' => 'Password'],
            ['group' => 'driver', 'key' => 'login_button', 'text_ar' => 'دخول', 'text_en' => 'Sign in'],
            ['group' => 'driver', 'key' => 'login_help', 'text_ar' => 'للمساعدة تواصل مع مشرف السائقين.', 'text_en' => 'Need help? Contact your driver supervisor.'],
            ['group' => 'driver', 'key' => 'invalid_credentials', 'text_ar' => 'رقم الهاتف أو كلمة المرور غير صحيحة', 'text_en' => 'Invalid phone or password'],
            ['group' => 'driver', 'key' => 'logout', 'text_ar' => 'خروج', 'text_en' => 'Logout'],
            ['group' => 'driver', 'key' => 'payroll', 'text_ar' => 'الرواتب', 'text_en' => 'Payroll'],
            ['group' => 'driver', 'key' => 'welcome', 'text_ar' => 'أهلاً بك', 'text_en' => 'Welcome'],
            ['group' => 'driver', 'key' => 'rating', 'text_ar' => 'التقييم', 'text_en' => 'Rating'],
            ['group' => 'driver', 'key' => 'commission', 'text_ar' => 'العمولة', 'text_en' => 'Commission'],
            ['group' => 'driver', 'key' => 'today_trips', 'text_ar' => 'رحلات اليوم', 'text_en' => "Today's trips"],
            ['group' => 'driver', 'key' => 'no_trips_today', 'text_ar' => 'لا توجد رحلات لليوم', 'text_en' => 'No trips today'],
            ['group' => 'driver', 'key' => 'upcoming', 'text_ar' => 'الرحلات القادمة', 'text_en' => 'Upcoming'],
            ['group' => 'driver', 'key' => 'back', 'text_ar' => 'رجوع', 'text_en' => 'Back'],
            ['group' => 'driver', 'key' => 'back_to_trip', 'text_ar' => 'رجوع للرحلة', 'text_en' => 'Back to trip'],
            ['group' => 'driver', 'key' => 'customer', 'text_ar' => 'العميل', 'text_en' => 'Customer'],
            ['group' => 'driver', 'key' => 'car', 'text_ar' => 'السيارة', 'text_en' => 'Car'],
            ['group' => 'driver', 'key' => 'pickup', 'text_ar' => 'مكان الانطلاق', 'text_en' => 'Pickup'],
            ['group' => 'driver', 'key' => 'dropoff', 'text_ar' => 'مكان الوصول', 'text_en' => 'Dropoff'],
            ['group' => 'driver', 'key' => 'start_trip', 'text_ar' => 'بدء الرحلة', 'text_en' => 'Start trip'],
            ['group' => 'driver', 'key' => 'start_button', 'text_ar' => 'بدء الرحلة الآن', 'text_en' => 'Start trip now'],
            ['group' => 'driver', 'key' => 'start_odometer', 'text_ar' => 'قراءة العداد عند البداية', 'text_en' => 'Start odometer reading'],
            ['group' => 'driver', 'key' => 'started_at', 'text_ar' => 'بدأت في', 'text_en' => 'Started at'],
            ['group' => 'driver', 'key' => 'start_km', 'text_ar' => 'بداية الكيلومتر', 'text_en' => 'Start km'],
            ['group' => 'driver', 'key' => 'end_trip', 'text_ar' => 'إنهاء الرحلة', 'text_en' => 'End trip'],
            ['group' => 'driver', 'key' => 'end_button', 'text_ar' => 'إنهاء الرحلة الآن', 'text_en' => 'End trip now'],
            ['group' => 'driver', 'key' => 'end_odometer', 'text_ar' => 'قراءة العداد عند النهاية', 'text_en' => 'End odometer reading'],
            ['group' => 'driver', 'key' => 'ended_at', 'text_ar' => 'انتهت في', 'text_en' => 'Ended at'],
            ['group' => 'driver', 'key' => 'end_km', 'text_ar' => 'نهاية الكيلومتر', 'text_en' => 'End km'],
            ['group' => 'driver', 'key' => 'trip_started', 'text_ar' => 'تم بدء الرحلة', 'text_en' => 'Trip started'],
            ['group' => 'driver', 'key' => 'trip_completed', 'text_ar' => 'تم إنهاء الرحلة', 'text_en' => 'Trip completed'],
            ['group' => 'driver', 'key' => 'cannot_start_in_status', 'text_ar' => 'لا يمكن بدء الرحلة في حالة :status', 'text_en' => 'Cannot start trip in :status status'],
            ['group' => 'driver', 'key' => 'not_in_progress', 'text_ar' => 'الرحلة ليست قيد التنفيذ', 'text_en' => 'Trip is not in progress'],
            ['group' => 'driver', 'key' => 'add_expense', 'text_ar' => 'إضافة مصروف للرحلة', 'text_en' => 'Add trip expense'],
            ['group' => 'driver', 'key' => 'new_expense', 'text_ar' => 'مصروف جديد', 'text_en' => 'New expense'],
            ['group' => 'driver', 'key' => 'trip_number', 'text_ar' => 'رقم الرحلة', 'text_en' => 'Trip #'],
            ['group' => 'driver', 'key' => 'expense_type', 'text_ar' => 'نوع المصروف', 'text_en' => 'Expense type'],
            ['group' => 'driver', 'key' => 'amount', 'text_ar' => 'المبلغ', 'text_en' => 'Amount'],
            ['group' => 'driver', 'key' => 'notes', 'text_ar' => 'ملاحظات', 'text_en' => 'Notes'],
            ['group' => 'driver', 'key' => 'receipt_photo', 'text_ar' => 'صورة الإيصال', 'text_en' => 'Receipt photo'],
            ['group' => 'driver', 'key' => 'receipt_help', 'text_ar' => 'اختياري — يمكنك التقاط صورة الإيصال بالكاميرا.', 'text_en' => 'Optional — use camera to capture the receipt.'],
            ['group' => 'driver', 'key' => 'submit_expense', 'text_ar' => 'حفظ المصروف', 'text_en' => 'Save expense'],
            ['group' => 'driver', 'key' => 'expense_submitted', 'text_ar' => 'تم تسجيل المصروف', 'text_en' => 'Expense recorded'],
            ['group' => 'driver', 'key' => 'net_payable_this_month', 'text_ar' => 'صافي المستحق هذا الشهر', 'text_en' => 'Net payable this month'],
            ['group' => 'driver', 'key' => 'gross_commission', 'text_ar' => 'إجمالي العمولة', 'text_en' => 'Gross commission'],
            ['group' => 'driver', 'key' => 'subtotal', 'text_ar' => 'المجموع الفرعي', 'text_en' => 'subtotal'],
            ['group' => 'driver', 'key' => 'deductions', 'text_ar' => 'الخصومات', 'text_en' => 'Deductions'],
            ['group' => 'driver', 'key' => 'fines_count', 'text_ar' => 'مخالفات', 'text_en' => 'fines'],
            ['group' => 'driver', 'key' => 'trips_this_period', 'text_ar' => 'رحلات الفترة', 'text_en' => 'Trips in this period'],
            ['group' => 'driver', 'key' => 'no_trips_this_period', 'text_ar' => 'لا توجد رحلات في هذه الفترة', 'text_en' => 'No trips in this period'],
            ['group' => 'driver', 'key' => 'fines_deducted', 'text_ar' => 'مخالفات مخصومة', 'text_en' => 'Deducted fines'],
        ];
