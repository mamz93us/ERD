...
class TranslationSeeder extends Seeder
{
    public function run(): void
    {
        $rows = [
            ...
            ['group' => 'portal', 'key' => 'brand', 'text_ar' => 'بوابة العملاء', 'text_en' => 'Customer Portal'],
            ['group' => 'portal', 'key' => 'login_title', 'text_ar' => 'تسجيل دخول العميل', 'text_en' => 'Customer login'],
            ['group' => 'portal', 'key' => 'login_subtitle', 'text_ar' => 'استخدم بريدك أو هاتفك وكلمة المرور', 'text_en' => 'Use your email or phone and password'],
            ['group' => 'portal', 'key' => 'email_or_phone', 'text_ar' => 'البريد الإلكتروني أو الهاتف', 'text_en' => 'Email or phone'],
            ['group' => 'portal', 'key' => 'password', 'text_ar' => 'كلمة المرور', 'text_en' => 'Password'],
            ['group' => 'portal', 'key' => 'login_button', 'text_ar' => 'دخول', 'text_en' => 'Sign in'],
            ['group' => 'portal', 'key' => 'login_help', 'text_ar' => 'للمساعدة تواصل معنا عبر واتساب.', 'text_en' => 'Need help? Reach us via WhatsApp.'],
            ['group' => 'portal', 'key' => 'invalid_credentials', 'text_ar' => 'بيانات الدخول غير صحيحة أو الحساب محظور.', 'text_en' => 'Invalid credentials or account blocked.'],
            ['group' => 'portal', 'key' => 'logout', 'text_ar' => 'خروج', 'text_en' => 'Logout'],
            ['group' => 'portal', 'key' => 'nav_dashboard', 'text_ar' => 'الرئيسية', 'text_en' => 'Home'],
            ['group' => 'portal', 'key' => 'nav_trips', 'text_ar' => 'الرحلات', 'text_en' => 'Trips'],
            ['group' => 'portal', 'key' => 'nav_quotations', 'text_ar' => 'العروض', 'text_en' => 'Quotations'],
            ['group' => 'portal', 'key' => 'nav_invoices', 'text_ar' => 'الفواتير', 'text_en' => 'Invoices'],
            ['group' => 'portal', 'key' => 'nav_profile', 'text_ar' => 'حسابي', 'text_en' => 'Profile'],
            ['group' => 'portal', 'key' => 'welcome_back', 'text_ar' => 'أهلاً بعودتك', 'text_en' => 'Welcome back'],
            ['group' => 'portal', 'key' => 'balance_due', 'text_ar' => 'الرصيد المستحق', 'text_en' => 'Balance due'],
            ['group' => 'portal', 'key' => 'no_balance', 'text_ar' => 'لا توجد مستحقات', 'text_en' => 'No outstanding balance'],
            ['group' => 'portal', 'key' => 'request_booking', 'text_ar' => 'طلب حجز جديد', 'text_en' => 'Request new booking'],
            ['group' => 'portal', 'key' => 'request_booking_title', 'text_ar' => 'طلب حجز جديد', 'text_en' => 'New booking request'],
            ['group' => 'portal', 'key' => 'request_booking_subtitle', 'text_ar' => 'سيتواصل معك فريقنا لتأكيد التفاصيل وإرسال عرض سعر.', 'text_en' => 'Our team will reach out to confirm details and send you a quotation.'],
            ['group' => 'portal', 'key' => 'pickup_location', 'text_ar' => 'مكان الانطلاق', 'text_en' => 'Pickup location'],
            ['group' => 'portal', 'key' => 'dropoff_location', 'text_ar' => 'مكان الوصول', 'text_en' => 'Dropoff location'],
            ['group' => 'portal', 'key' => 'pickup_at', 'text_ar' => 'موعد الانطلاق', 'text_en' => 'Pickup at'],
            ['group' => 'portal', 'key' => 'dropoff_at', 'text_ar' => 'موعد الوصول', 'text_en' => 'Dropoff at'],
            ['group' => 'portal', 'key' => 'estimated_distance_km', 'text_ar' => 'المسافة التقديرية (كم)', 'text_en' => 'Estimated distance (km)'],
            ['group' => 'portal', 'key' => 'requirements', 'text_ar' => 'تفاصيل وملاحظات', 'text_en' => 'Details and notes'],
            ['group' => 'portal', 'key' => 'requirements_help', 'text_ar' => 'عدد الركاب، نوع السيارة المفضلة، أي طلبات خاصة.', 'text_en' => 'Number of passengers, preferred car type, any special requests.'],
            ['group' => 'portal', 'key' => 'submit_booking', 'text_ar' => 'إرسال الطلب', 'text_en' => 'Submit request'],
            ['group' => 'portal', 'key' => 'booking_request_received', 'text_ar' => 'استلمنا طلبك وسنعود إليك قريباً.', 'text_en' => "We've received your request and will get back to you soon."],
            ['group' => 'portal', 'key' => 'active_trips', 'text_ar' => 'الرحلات النشطة', 'text_en' => 'Active trips'],
            ['group' => 'portal', 'key' => 'no_active_trips', 'text_ar' => 'لا توجد رحلات نشطة', 'text_en' => 'No active trips'],
            ['group' => 'portal', 'key' => 'open_quotations', 'text_ar' => 'العروض المفتوحة', 'text_en' => 'Open quotations'],
            ['group' => 'portal', 'key' => 'no_open_quotations', 'text_ar' => 'لا توجد عروض مفتوحة', 'text_en' => 'No open quotations'],
            ['group' => 'portal', 'key' => 'unpaid_invoices', 'text_ar' => 'الفواتير غير المدفوعة', 'text_en' => 'Unpaid invoices'],
            ['group' => 'portal', 'key' => 'no_unpaid_invoices', 'text_ar' => 'لا توجد فواتير غير مدفوعة', 'text_en' => 'No unpaid invoices'],
            ['group' => 'portal', 'key' => 'valid_until', 'text_ar' => 'صالح حتى', 'text_en' => 'Valid until'],
            ['group' => 'portal', 'key' => 'due', 'text_ar' => 'الاستحقاق', 'text_en' => 'Due'],
            ['group' => 'portal', 'key' => 'due_in', 'text_ar' => 'مستحق', 'text_en' => 'Due'],
            ['group' => 'portal', 'key' => 'issued', 'text_ar' => 'صدرت في', 'text_en' => 'Issued'],
            ['group' => 'portal', 'key' => 'balance', 'text_ar' => 'الرصيد', 'text_en' => 'Balance'],
            ['group' => 'portal', 'key' => 'my_trips', 'text_ar' => 'رحلاتي', 'text_en' => 'My trips'],
            ['group' => 'portal', 'key' => 'no_trips_yet', 'text_ar' => 'لا توجد رحلات بعد', 'text_en' => 'No trips yet'],
            ['group' => 'portal', 'key' => 'back_to_trips', 'text_ar' => 'رجوع للرحلات', 'text_en' => 'Back to trips'],
            ['group' => 'portal', 'key' => 'driver', 'text_ar' => 'السائق', 'text_en' => 'Driver'],
            ['group' => 'portal', 'key' => 'car', 'text_ar' => 'السيارة', 'text_en' => 'Car'],
            ['group' => 'portal', 'key' => 'pickup', 'text_ar' => 'الانطلاق', 'text_en' => 'Pickup'],
            ['group' => 'portal', 'key' => 'dropoff', 'text_ar' => 'الوصول', 'text_en' => 'Dropoff'],
            ['group' => 'portal', 'key' => 'total', 'text_ar' => 'الإجمالي', 'text_en' => 'Total'],
            ['group' => 'portal', 'key' => 'related_invoices', 'text_ar' => 'فواتير مرتبطة', 'text_en' => 'Related invoices'],
            ['group' => 'portal', 'key' => 'my_quotations', 'text_ar' => 'عروض الأسعار', 'text_en' => 'My quotations'],
            ['group' => 'portal', 'key' => 'no_quotations_yet', 'text_ar' => 'لا توجد عروض بعد', 'text_en' => 'No quotations yet'],
            ['group' => 'portal', 'key' => 'back_to_quotations', 'text_ar' => 'رجوع للعروض', 'text_en' => 'Back to quotations'],
            ['group' => 'portal', 'key' => 'car_category', 'text_ar' => 'فئة السيارة', 'text_en' => 'Car category'],
            ['group' => 'portal', 'key' => 'distance', 'text_ar' => 'المسافة', 'text_en' => 'Distance'],
            ['group' => 'portal', 'key' => 'subtotal', 'text_ar' => 'المجموع الفرعي', 'text_en' => 'Subtotal'],
            ['group' => 'portal', 'key' => 'vat', 'text_ar' => 'الضريبة (14%)', 'text_en' => 'VAT (14%)'],
            ['group' => 'portal', 'key' => 'accept', 'text_ar' => 'قبول العرض', 'text_en' => 'Accept'],
            ['group' => 'portal', 'key' => 'reject', 'text_ar' => 'رفض', 'text_en' => 'Reject'],
            ['group' => 'portal', 'key' => 'reject_confirm', 'text_ar' => 'هل أنت متأكد؟', 'text_en' => 'Are you sure?'],
            ['group' => 'portal', 'key' => 'quotation_accepted', 'text_ar' => 'تم قبول العرض، سنتواصل معك لتأكيد الحجز.', 'text_en' => 'Quotation accepted — we will be in touch to confirm the booking.'],
            ['group' => 'portal', 'key' => 'quotation_rejected', 'text_ar' => 'تم رفض العرض.', 'text_en' => 'Quotation rejected.'],
            ['group' => 'portal', 'key' => 'quotation_not_decidable', 'text_ar' => 'لا يمكن تغيير حالة هذا العرض.', 'text_en' => "This quotation can't be acted on anymore."],
            ['group' => 'portal', 'key' => 'my_invoices', 'text_ar' => 'فواتيري', 'text_en' => 'My invoices'],
            ['group' => 'portal', 'key' => 'no_invoices_yet', 'text_ar' => 'لا توجد فواتير بعد', 'text_en' => 'No invoices yet'],
            ['group' => 'portal', 'key' => 'back_to_dashboard', 'text_ar' => 'رجوع للرئيسية', 'text_en' => 'Back to home'],
            ['group' => 'portal', 'key' => 'my_profile', 'text_ar' => 'حسابي', 'text_en' => 'My profile'],
            ['group' => 'portal', 'key' => 'full_name', 'text_ar' => 'الاسم', 'text_en' => 'Full name'],
            ['group' => 'portal', 'key' => 'phone', 'text_ar' => 'الهاتف', 'text_en' => 'Phone'],
            ['group' => 'portal', 'key' => 'whatsapp', 'text_ar' => 'واتساب', 'text_en' => 'WhatsApp'],
            ['group' => 'portal', 'key' => 'email', 'text_ar' => 'البريد الإلكتروني', 'text_en' => 'Email'],
            ['group' => 'portal', 'key' => 'company', 'text_ar' => 'الشركة', 'text_en' => 'Company'],
